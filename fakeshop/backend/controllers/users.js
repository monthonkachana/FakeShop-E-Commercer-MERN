...
exports.userCart = async (req, res) => {
  try {
    ...
    for (let i = 0; i < cart.length; i++) {
      ...
      //loopสินค้าแต่ละชิ้น เสจส่งไปเก็บ [{1},{2},{3}]  push
...
exports.saveOrder = async (req, res) => {
  try {
    ...
    // + - products Docวิธีตัดสต๊อกสินค้า>> https://www.mongodb.com/docs/manual/reference/operator/update/inc/#example
